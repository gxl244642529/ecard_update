...
import { ART, InteractionManager } from 'react-native';
...
const BackIcon = props => {
  return (
    <Surface width={15} height={17} style={props.style}>
      <Group scale={1.3}>
        <Shape
          fill={'#ffffff'}
...
export default class SearchBar extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      marginLeft: new Animated.Value(pos),
    };
  }
    ...
    return (
      <View style={[styles.searchRow, this.props.style]}>
        ...
        <View style={styles.textContainer}>
          <Animated.View
            style={[styles.row, { marginLeft: this.state.marginLeft }]}
          >
            <SearchIcon style={styles.searchIcon} />
            {!this.state.value && (
              <Text style={styles.text} onLayout={this.onLayout}>
