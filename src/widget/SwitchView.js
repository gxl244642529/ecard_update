...
export default class SwitchView extends Component {
  ...
  render() {
    ...
    return (
      <View
        style={
          this.props.switchTrue
            ? [styles.swithView, styles.havebackgroud]
            : [styles.swithView, styles.nobackgroud]
        }
      >
        <TouchableOpacity
          style={
            this.props.switchTrue
              ? [styles.radiu, styles.noradiunobord]
              : [styles.radiu, styles.radiunobord]
          }
