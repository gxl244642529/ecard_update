...
const IC_ForwardArrow = () => {
  let path =
    'M767.707334 519.450692 308.065819 71.476915 256.054235 122.209366 663.627884 519.419993 256.085958 916.629597 308.060703 967.363072Z';
  return (
    <Surface width={15} height={19}>
      <Group scale={0.015}>
        <Shape fill="#999999" d={path} />
      </Group>
    </Surface>
  );
};
