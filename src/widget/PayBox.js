...
class CodeCell extends Component {
  render() {
    return (
      <View style={[styles.codecell, StandardStyle.center]}>
  ...
  render() {
    return (
      <TouchableOpacity
        ...
        style={[
          styles.numcell,
          StandardStyle.center,
          StandardStyle.row,
          this.props.center && styles.bothBorder,
        ]}
      >
        <Text style={[styles.numcellText, this.props.disabled && styles.gray]}>
          {this.props.index}
        </Text>
      </TouchableOpacity>
    );
        ...
        <Animated.View style={[styles.paybox, { height: this.state.fadeAnim }]}>
          ...
          <View>
            <View style={styles.numlist}>
              <NumCell
                index={1}
                onPress={() => this._addDot(1)}
                disabled={locked}
              />
              <NumCell
                index={2}
                onPress={() => this._addDot(2)}
                disabled={locked}
                center={true}
              />
              <NumCell
                index={3}
                onPress={() => this._addDot(3)}
                disabled={locked}
              />
            </View>
            <View style={styles.numlist}>
              <NumCell
                index={4}
                onPress={() => this._addDot(4)}
                disabled={locked}
              />
              <NumCell
                index={5}
                onPress={() => this._addDot(5)}
                disabled={locked}
                center={true}
              />
              <NumCell
                index={6}
                onPress={() => this._addDot(6)}
                disabled={locked}
              />
            </View>
            <View style={styles.numlist}>
              <NumCell
                index={7}
                onPress={() => this._addDot(7)}
                disabled={locked}
              />
              <NumCell
                index={8}
                onPress={() => this._addDot(8)}
                disabled={locked}
                center={true}
              />
              <NumCell
                index={9}
                onPress={() => this._addDot(9)}
                disabled={locked}
              />
            </View>
            <View style={styles.numlist}>
              <View style={[styles.numcell, styles.numcellBlack]} />
              <NumCell
                index={0}
                onPress={() => this._addDot(1)}
                center={true}
              ...
              >
                <Text style={[styles.numcellText, StandardStyle.fontWhite]}>
                  ×
                </Text>
              </TouchableOpacity>
            </View>
