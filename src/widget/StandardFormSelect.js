...
const renderImage = () => {
  return (
    <Image style={styles.rightArrow} source={require('../img/ic_arrow.png')} />
  );
};
    ...
    return (
      <View>
        ...
        >
          ...
          <Text
            style={
              index >= 0 ? [styles.holder, styles.holderDark] : styles.holder
            }
          >
            {index >= 0 ? this.props.labels[index] : this.props.placeholder}
          </Text>
