...
import { StyleSheet, Text, View, CommonStyle } from '../../lib/Common';
        ...
        <View style={styles.itemTitle}>
          ...
          <Text
            style={[
              ...
              this.props.active && styles.itemTitleTextActive,
            ]}
          >
            {this.props.title}
          </Text>
  ...
  render() {
    return (
      <View style={styles.container}>
        <Items
          title={
            this._isActive(1) && !this._isCurrentStep(1)
              ? '挂失处理完毕'
              : '挂失处理中'
          }
          active={this._isActive(1)}
          msg={this.props.lost}
          renderIcon={this._renderIcon(1)}
        />
        ...
        <Items
          title={
            this._isActive(2) && !this._isCurrentStep(2)
              ? '打款处理完毕'
              : '打款中'
          }
        ...
        <Items
          title={
            !this._isActive(3) && !this._isCurrentStep(3)
              ? '打款结果'
              : this.props.status == 1 && this._isCurrentStep(3)
                ? '打款失败' + this.props.failReason
                : '打款成功'
          }
          active={this._isActive(3)}
          msg={this.props.msg}
          renderIcon={this._renderIcon(3)}
        />
      </View>
    );
  }
