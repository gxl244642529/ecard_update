...
export default class BindingWays extends Component {
  ...
  _goUrl = () => {
    WebUtil.open(
      Api.imageUrl + '/index.php/sys_agree_detail/content/realLetter',
      ''
    );
  };
        ...
        <View style={styles.center}>
          {this.state.hasNfc && (
            <Option
              ...
              renderImg={
                <Image
                  source={require('./images/vertify_nfc.png')}
                  style={styles.img}
                />
              }
              onPress={() => this.onChangeIndex(1)}
          ...
          <Option
            ...
            renderImg={
              <Image
                source={require('./images/vertify_budeng.png')}
                style={styles.img2}
              />
            }
