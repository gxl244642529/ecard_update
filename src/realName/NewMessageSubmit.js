        ...
        <ScrollView>
          ...
          {this.props.errorMsg && (
            <View style={{ padding: 15 }}>
              <Text style={{ color: '#e8464c' }}>
                上一次身份认证失败，失败原因：{this.props.errorMsg}
              </Text>
            </View>
          )}
          <FormInput
          ...
          <FormSelect
            ...
            onChange={(index, idType) => {
              this._setIdType(index, idType);
            }}
          />
          <FormInput
            label="证件号码:"
          ...
          <View style={styles.Photo}>
            <View style={styles.Photo_text}>
              ...
              {parseInt(this.state.idType) == 1 &&
                this.state.imgType == 0 && (
                  <Text style={[StandardStyle.h5, StandardStyle.fontBlack]}>
                    请上传身份证正反面照片
                  </Text>
                )}
              {parseInt(this.state.idType) != 1 && (
          ...
          <View style={styles.Photo_img}>
            ...
            >
              <Image
                style={styles.photo}
                source={
                  this.state.img1 ? { uri: this.state.img1 } : img1Default
                }
              />
            </ImagePicker>
            <ImagePicker
            ...
            >
              <Image
                style={styles.photo}
                source={
                  this.state.img2 ? { uri: this.state.img2 } : img2Default
                }
              />
            </ImagePicker>
          </View>
