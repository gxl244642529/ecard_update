...
export function renderHeadPng() {
  return (
    <Image
      ...
      source={require('./images/background_4.png')}
    >
      <View>
        <Image
          source={require('./images/card_4.png')}
  ...
  return (
    <Image source={require('./images/background.png')} style={styles.backBotom}>
      <View style={{ backgroundColor: 'transparent', padding: 5 }}>
        ...
        >
          2.为了您e通卡的资金安全，请尽快对已绑定的卡片开通挂失服务;
        </Text>
        <Text
          style={[
            StandardStyle.h5,
        ...
        >
          4.若有异常情况，请您拨打客服热线<Text
            ...
            onPress={() => makePhoneCall('0592968870')}
          >
            968870>>
          </Text>
        </Text>
...
export default class OpenLostConfirm extends Component {
  ...
  _url = () => {
    WebUtil.open(
      Api.imageUrl + '/index.php/sys_agree_detail/content/realcard',
      ''
    );
  };
      ...
      <View style={styles.confirmView}>
        <View style={styles.confirmViewAb}>
          <View style={styles.titleView}>
            <Image
              source={require('./images/title_left.png')}
              style={{ width: 35, height: 18 }}
              resizeMode="contain"
            />
            <Text style={styles.titletext}>真实性承诺函</Text>
            <Image
              source={require('./images/title_right.png')}
              style={{ width: 35, height: 18 }}
              resizeMode="contain"
            />
          </View>
          <ScrollView style={{ flex: 1 }}>
            <WebView
              ...
              source={{
                uri:
                  Api.imageUrl + '/index.php/sys_agree_detail/content/confirm',
                method: 'GET',
              }}
  ...
  render() {
    ...
    let placeholder = this.state.hasNfc
      ? '请输入e通卡卡号或贴卡读取'
      : '请输入e通卡卡号';
    return (
      <View style={[CommonStyle.container, { backgroundColor: '#fff' }]}>
        <TitleBar
          title={'开通挂失'}
          isNoleft={this.state.data.fromto == FROM_REAL && true}
          renderRight={this.state.data.fromto == FROM_REAL && this._renderRight}
          onBack={this._onBack}
        />
        <ScrollView>
          {renderHeadPng()}
          ...
          <View>
            ...
            />
            <ECardSelector
              onSelectECard={this.onSelectECard}
              style={styles.Verification_code}
          ...
          <LoadingButton
            ...
            style={
              this.state.submiting
                ? loadingButtonRealDisabled
                : loadingButton.loadingButtonReal
            }
        ...
        {this.state.alertConfirm && (
          <ConfirmAlert noagree={this._noagree} agree={this._agree} />
        )}
      </View>
    );
  }
