    ...
    itemStateCompont = (
      <View style={{ justifyContent: 'space-between' }}>
        ...
        <TouchableOpacity
          style={[
            styles.lostTouStyle,
            { marginTop: 10, backgroundColor: '#DBDBDB' },
          ]}
          onPress={() => {
            _cancel(rowData);
          }}
    ...
    <View key={rowData.cardId}>
      ...
      >
        <View style={styles.msgViewStyle}>
          ...
          <View style={styles.itemStyle}>{itemState(rowData)}</View>
        </View>
      </TouchableOpacity>
      {lineView()}
    </View>
    ...
    return (
      <View>
        <View style={this.props.msgSty ? this.props.msgSty : styles.main}>
          <Text style={[StandardStyle.h3, StandardStyle.fontBlack]}>
            {this.props.tip}
          </Text>
          <Text style={[StandardStyle.h4, StandardStyle.fontBlack]}>
            {this.props.msg} {this.props.msgTo}
          </Text>
        </View>
        {lineView()}
      </View>
