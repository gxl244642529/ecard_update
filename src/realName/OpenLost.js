    ...
    return (
      <View>
        <TouchableOpacity
          style={[
            StandardStyle.row,
            { alignItems: 'center', padding: 25, marginLeft: 25 },
          ]}
          onPress={this.props.onPress}
        >
          {this.props.keyindex == this.props.onClickindex ? (
            <Image
              source={require('./images/radiose.png')}
              style={{ width: 25, height: 25 }}
              resizeMode="contain"
            />
          ) : (
            <Image
              source={require('./images/radionose.png')}
              style={{ width: 25, height: 25 }}
              resizeMode="contain"
            />
          )}
    ...
    return (
      <View style={[CommonStyle.container, { backgroundColor: '#fff' }]}>
        <TitleBar
          ...
          renderRight={this.state.data.fromto == 0 && this._renderRight}
          onBack={this._onBack}
        />
        <ScrollView>
          {renderHeadPng()}
