    ...
    return (
      <View style={[CommonStyle.container, container.container]}>
        ...
        <ScrollView>
          ...
          {this.state.lostStatus === LOST && (
            <ReportProcess step={1} lost={TIP_1} status={0} />
          )}
          {this.state.lostStatus === FUNDING && (
            <ReportProcess
              step={2}
              name={name}
              card={card}
          ...
          {this.state.lostStatus === FUND_SUCCESS && (
            <ReportProcess
              step={3}
              name={name}
              card={card}
          ...
          {this.state.lostStatus === RESULT_LACKOFMONEY && (
            <View>
              <ReportProcess
                step={3}
                name={name}
          ...
          {this.state.lostStatus === FUND_ERROR && (
            <View>
              <ReportProcess
                step={3}
                name={name}
