...
export default class RealLead extends Component {
  ...
  _url = () => {
    console.log('链接到指定位置');
    WebUtil.open(
      Api.imageUrl + '/index.php/sys_agree_detail/content/realverify',
      ''
    );
  };
        ...
        <ScrollView>
          ...
          <View>
            ...
            <View style={styles.Recharge_text}>
              ...
              <Text style={[StandardStyle.h5, StandardStyle.fontWhite]}>
                1.身份认证时需要核实您的有效身份信息，认证通过后即可享受挂失服务。
              </Text>
              <Text style={[StandardStyle.h5, StandardStyle.fontWhite]}>
                2.身份认证时需要验证您的银行卡信息，卡片挂失后的余额将返回至您绑定的银行卡。
              </Text>
            </View>
          </View>
          <CheckBox
